---
inclusion: fileMatch
fileMatchPattern: ["backend/**/*.rs", "backend/migrations/**/*", "frontend/**/*.rs", "android/**/*.kt"]
---

# Product Domain Model

Entities, invariants, and state values for the property-management domain. Roles, permissions, and localization live in the always-on `product.md`.
