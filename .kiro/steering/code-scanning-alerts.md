...
How to list and triage open GitHub code scanning alerts (CodeQL + Trivy + Semgrep) from the CLI.
...
## List open alerts (raw JSON to file)
...
## Parse with jq (short queries only)
