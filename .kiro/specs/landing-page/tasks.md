...
- [x] 3. Implement landing section components (part 2: Features, Preview, Transparency, Footer)
  ...
  - [x] 3.4 Create `frontend/src/components/landing/footer.rs` — Landing footer component
...
- [x] 4. Implement landing page and route integration
  ...
  - [x] 4.2 Register the landing page in `frontend/src/pages/mod.rs`
    - Add `pub mod landing;` to the existing module declarations
    - _Requirements: 11.1_
...
- [x] 6. Add placeholder asset and tests
  ...
  - [x] 6.2 Write property test for step card rendering completeness
  ...
  - [x] 6.4 Write property test for secondary CTA styling consistency
  ...
  - [x] 6.5 Write unit tests for route mapping and auth redirect
