...
- [ ] 1. Database migration and data model
  - [ ] 1.1 Create migration `m20260607_000001_add_guidance_rules_to_chatbot_config.rs`
    - Add column `guidance_rules` (JSONB NOT NULL DEFAULT '[]') to `chatbot_config` table
    - _Requirements: 1.1, 1.3_

  - [ ] 1.2 Create migration `m20260607_000002_seed_guidance_rule_templates.rs`
  ...
  - [ ] 1.3 Update the `chatbot_config` entity to include the `guidance_rules` field
