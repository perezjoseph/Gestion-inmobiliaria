...
| Async | `references/async.md` | async/await, tokio, futures, streams, concurrency, deadlocks |
| Testing | `references/testing.md` | Unit/integration tests, proptest, benchmarks, test deadlocks |
...
Rust 2024, Cargo, ownership/borrowing, lifetimes, traits, generics, async/await, tokio, Result/Option, thiserror/anyhow, serde, clippy, rustfmt, cargo-test, criterion benchmarks, MIRI, unsafe Rust
