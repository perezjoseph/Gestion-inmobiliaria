 ...
 */
class ContratoDateOrderingPropertyTest : FreeSpec({
    ...
    val dateArb: Arb<LocalDate> = Arb.localDate(
    ...
    "Property 11: Contrato date ordering validation" - {
        ...
        "fechaFin before fechaInicio returns Invalid for fechaFin" {
            checkAll(100, dateArb, Arb.int(1..3650), nonBlankArb, nonBlankArb, posDecimalArb) {
