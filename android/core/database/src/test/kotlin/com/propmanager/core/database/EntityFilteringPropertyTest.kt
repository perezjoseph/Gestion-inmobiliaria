 ...
 */
class EntityFilteringPropertyTest : FreeSpec({
    ...
    ): List<PropiedadEntity> = entities.filter { e ->
    ...
    fun filterPagos(
        ...
        contratoId: String?,
        estado: String?
    ): List<PagoEntity> = entities.filter { e ->
    ...
    fun filterGastos(
        ...
        categoria: String?,
        estado: String?
    ): List<GastoEntity> = entities.filter { e ->
    ...
    fun filterSolicitudes(
        ...
        prioridad: String?,
        propiedadId: String?
    ): List<SolicitudMantenimientoEntity> = entities.filter { e ->
        (estado == null || e.estado == estado) &&
