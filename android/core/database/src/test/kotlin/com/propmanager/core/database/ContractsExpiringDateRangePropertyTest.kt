 ...
 */
class ContractsExpiringDateRangePropertyTest : FreeSpec({
    ...
    "Property 9: Contracts-expiring date range filter" - {
        ...
        "returns exactly contratos with fecha_fin in [today, today + threshold]" {
            ...
            checkAll(
                ...
                val expected = contratos.filter { c ->
                    val fechaFin = LocalDate.parse(c.fechaFin, apiFormat)
                    !fechaFin.isBefore(rangeStart) && !fechaFin.isAfter(rangeEnd)
                }
        ...
        "excludes contratos with fecha_fin before today" {
            ...
            checkAll(
                ...
                val pastContrato = ContratoEntity(
                    id = "past-1",
                    propiedadId = "prop-1",
                    inquilinoId = "inq-1",
        ...
        "excludes contratos with fecha_fin after today + threshold" {
            ...
            checkAll(
                ...
                val futureContrato = ContratoEntity(
                    id = "future-1",
                    propiedadId = "prop-1",
                    inquilinoId = "inq-1",
        ...
        "includes contratos on boundary dates (today and today + threshold)" {
            ...
            checkAll(
                ...
                val boundaryToday = ContratoEntity(
                    id = "boundary-today",
                    propiedadId = "prop-1",
                    inquilinoId = "inq-1",
                ...
                val boundaryEnd = ContratoEntity(
                    id = "boundary-end",
                    propiedadId = "prop-2",
                    inquilinoId = "inq-2",
                    fechaInicio = dateToString(today),
                ...
                val result = filterExpiring(
                    listOf(boundaryToday, boundaryEnd), today, threshold
                )
