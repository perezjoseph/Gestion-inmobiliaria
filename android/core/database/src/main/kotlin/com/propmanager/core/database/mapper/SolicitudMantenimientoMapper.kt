...
fun SolicitudMantenimientoEntity.toDomain(): SolicitudMantenimiento = SolicitudMantenimiento(
    id = id,
...
fun SolicitudDto.toEntity(): SolicitudMantenimientoEntity = SolicitudMantenimientoEntity(
    id = id,
    propiedadId = propiedadId,
    unidadId = unidadId,
    inquilinoId = inquilinoId,
...
fun SolicitudMantenimiento.toCreateRequest(): CreateSolicitudRequest = CreateSolicitudRequest(
    propiedadId = propiedadId,
    unidadId = unidadId,
    inquilinoId = inquilinoId,
    titulo = titulo,
