...
fun InquilinoEntity.toDomain(): Inquilino = Inquilino(
    id = id,
    nombre = nombre,
    apellido = apellido,
    email = email,
...
fun InquilinoDto.toEntity(): InquilinoEntity = InquilinoEntity(
    id = id,
    nombre = nombre,
    apellido = apellido,
    email = email,
...
fun Inquilino.toCreateRequest(): CreateInquilinoRequest = CreateInquilinoRequest(
    nombre = nombre,
    apellido = apellido,
    email = email,
    telefono = telefono,
