...
@Singleton
class AuditoriaRepository @Inject constructor(private val apiService: AuditoriaApiService) {
    suspend fun fetchAuditLog(
        filters: Map<String, String> = emptyMap()
    ): Result<PaginatedResponse<AuditoriaDto>> = runCatching {
        apiService.list(filters).body() ?: throw EmptyResponseException("auditoria")
    }
}
