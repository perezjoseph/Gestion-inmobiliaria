...
interface PagosApiService {
    ...
    @GET("api/pagos")
    suspend fun list(@QueryMap filters: Map<String, String> = emptyMap()): Response<PaginatedResponse<PagoDto>>

    @POST("api/pagos")
    suspend fun create(@Body request: CreatePagoRequest): Response<PagoDto>
