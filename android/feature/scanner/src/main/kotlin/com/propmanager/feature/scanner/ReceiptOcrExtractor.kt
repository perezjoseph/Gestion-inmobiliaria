...
class ReceiptOcrExtractor
    ...
    constructor() {
        ...
        private val facturaPattern = Regex("""(?:factura|invoice|no\.?|num\.?|#)\s*:?\s*([A-Z0-9-]+)""", RegexOption.IGNORE_CASE)
        ...
        private fun extractNumeroFactura(text: String): String? = facturaPattern.find(text)?.groupValues?.get(1)
    }
