...
class AuthViewModelTest : FreeSpec({
    ...
    "401 clears session via onSessionExpired" {
        val fakeToken = FakeTokenProvider().apply {
...
private class FakeTokenProvider : TokenProvider {
    ...
    override fun saveUserProfile(user: UserProfile) { profile = user }
    override fun getUserProfile(): UserProfile? = profile
    override fun clearAll() { token = null; profile = null }
}
